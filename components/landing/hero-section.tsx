...
export function HeroSection({ stats, isLoading, featuredJobs, onExploreJobs, onSignIn }: HeroSectionProps) {
  return (
      ...
      <div className="grid items-center gap-12 lg:grid-cols-2">
        <div className="space-y-8">
          <div className="space-y-4">
            ...
            <h1 className="text-4xl font-bold text-gray-900 sm:text-5xl lg:text-6xl">Build a career with purpose</h1>
            <p className="text-lg text-gray-600 sm:text-xl">
              Connect with leading employers in Nigeria&apos;s green sector. Find roles in renewable energy, sustainability, and climate tech.
            </p>
          </div>
            ...
            <div id="jobs" className="space-y-4">
              {isLoading ? (
                ...
                featuredJobs.map((job) => (
                  <div key={job._id} className="rounded-lg border border-gray-200 bg-white p-5 transition hover:shadow-md">
                ...
                <div className="rounded-lg bg-white p-6 text-center text-sm text-gray-500">No positions available at this time.</div>
              )}
            </div>
